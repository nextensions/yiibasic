...
<div class="row" style="margin-left: 0px;margin-right: 0px">
    <div>
        ...
        <div class="column4" style="padding-top: 5px">
            ...
            <b>
                ภาคเรียนที่ <?php echo "2" ?>
                ปีการศึกษา <?php echo "2566" ?></b>
        </div>
    </div>

    <p style="float: right;width: 22%;padding: 5px;font-weight: bold;margin-top: -80px;text-align: center;border-width: 1px;border-style: solid;">
        ส่วนที่ 1 (สำหรับนักเรียน)
    </p>
    <div class="row" style="margin-left: 0px; margin-right: 0px">
        <div style="margin-left: 0px;margin-right: 0px;margin-top: 10px;float: left;width: 20%;">
        ...
        <div>
            <b>
                <?php echo "เด็กชายกิตติธัช สนืทราษฎร์" ?><br />
                <?php echo "13980" ?><br />
                <?php echo "ม.1/1" ?><br /></b>
        </div>
        ...
        <div style="margin-top: 5px">
            <table class="table table-bordered table-sm table-collapse" style="border: 1px solid">
                ...
                <tr>
                    <td style="width: 450px;padding-top: 0px;padding-bottom: 0px;vertical-align: middle;border: 1px solid;">
                        <b>( สองพันบาทถ้วน )</b>
                    </td>
        ...
        <div style="padding-left: -40px; float: right">
            <table class="table table-bordered table-sm table-collapse">
                <tr>
                    <th style="line-height: 1.5;padding-top: 5px;margin-bottom: -40px;border: 1px solid;">
    ...
    <div class="row" style="margin-left: 0px">
        ...
        <div class="column4" style="padding-top: -10px; margin-left: -15px">
            <h5 style="line-height: 22px">
            ...
            <table class="table table-bordered table-sm table-collapse">
                ...
                <tr>
                    <td style="width: 200px;padding-top: 0px;padding-bottom: 0px;vertical-align: middle;text-align: right;border: 1px solid;height: 50px;">
                        สำหรับเจ้าหน้าที่ธนาคาร
                    </td>
                    <td colspan="3" style="width: 300px;padding-top: 0px;padding-bottom: 0px;vertical-align: middle;text-align: right;border: 1px solid;height: 50px;">

                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="background-color: #2dfeff; border: 1px solid">
                        <h5>
                            กำหนดชำระที่ธนาคารกรุงไทยทุกสาขา 13 พฤศจิกายน - 1 ธันวาคม 2566
                        </h5>
                    </td>
                </tr>
                </tbody>
        ...
        <?php $qr = '099400026587500-13980-101-200000';
        $codabar1 = '099400026587500-13980-101-200000';
        ?>
        <div style="margin-top: 10px">
            <div class="column3" style="margin-left: 40px">
                <barcode code="<?=$qr?>" type="QR" size="0.8" error="M" disableborder="1"/>
            </div>
            <div class="barcodecell">
                <barcode code="<?=$codabar1?>" type="CODABAR" class="barcode" height="1.5"/>
                <div style="text-align: left">
                    <p style="font-size: 16px"><?php  echo $codabar1 ?></p>
                </div>
            </div>
        </div>
    </div>
